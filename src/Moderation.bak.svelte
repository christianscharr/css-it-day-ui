...
<div class="container">
    {#if savefile !== null}
        ...
        {#each blocklyIn as { variable, value }}
            <div class="field">
                <label class="label" for="input-{variable}">Input "{variable}"</label>
                <div class="control">
                    <input id="input-{variable}" class="input" type="text" name="{variable}">
                </div>
            </div>
        {/each}
    {/if}
        ...
        <nav class="panel">
            ...
            {#each versions as { sprint, timestamp }, j}
                <div class="panel-block">
                    ...
                    <button class="load-and-simulate button is-primary" on:click={ loadSavefile(name, sprint, timestamp) }>
